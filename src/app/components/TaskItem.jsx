...
const TaskItem = ({ task, onDelete }) => {
  ...
  return (
    <div className="group bg-stone-900/80 backdrop-blur-xl rounded-xl border border-green-800/30 p-6 hover:border-green-700/50 transition-all duration-300 hover:shadow-xl hover:shadow-green-900/20">
      <div className="flex items-start justify-between mb-4">
        <Link href={`/tasks/${task.id}`}>
          <h3 className="text-xl cursor-pointer font-semibold text-green-400 group-hover:text-green-300 transition-colors">
            {task.title}
          </h3>
        </Link>
